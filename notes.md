...
After, `wt_max` is computed inside `_compute_weights_aa`:
```
Num threads: 1
...
### Fix non-input issue (https://github.com/pytorch/pytorch/pull/101136)


Issue is with `unpack_rgb`

#### Try manual loop + if/else conditions on strides
